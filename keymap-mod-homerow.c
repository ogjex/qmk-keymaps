...
enum tap_dance_codes {
  ...
  DANCE_60,
  DANCE_63,
  DANCE_ENTER, // NEEDS TO BE WRITTEN
  BKSL_HME,
  PIPE_END,
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
      KC_Q,   KC_W,     KC_E,     KC_R,    KC_T, /*break */    						KC_Y,   KC_U,   KC_I,   MT(KC_O, DK_OSTR),  KC_P,
  //------------------------------------------------------------------------------       		----------------------------------------------------------------------------
      MT(KC_A, DK_ARNG),    MT(MOD_LSFT,KC_S),    MT(MOD_LALT,KC_D),    MT(MOD_LCTL,KC_F),    MT(MOD_LGUI,KC_G), /*break */ 	MT(MOD_LGUI,KC_H),   MT(MOD_RCTL,KC_J),   MT(MOD_RALT,KC_E),  MT(MOD_RSFT,KC_L),  TD(DANCE_ENTER),
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------
